...
with col1:
    st.markdown(
        ...
        <div style='text-align: center;'>
            ...
            <p> - 👧 Personal Details </br> - 💗 Likes / Dislikes </br> - ⭐ Skills </br> - 📚 Interests </br> - 🎖️ Certifications & Seminars</p>
...
tabs = ["👧 Personal Details", "💗 Likes / Dislikes", "⭐ Skills", "📚 Interests", "🎖️ Certifications & Seminars"]
        ...
        st.markdown(
            ...
            <div style='font-size: 1.2rem;'>
                ...
                <ul>
                    ...
                    <li style='font-size: 1.1rem; font-weight: bold'>🔥 I don't like very hot weather.</li>
                    <li style='font-size: 1.1rem; font-weight: bold'>🛌 I don't like waking up early.</li>
                    <li style='font-size: 1.1rem; font-weight: bold'>👩‍💼 I don't like presenting to a large audience.</li>
                    <li style='font-size: 1.1rem; font-weight: bold'>🚃 I don’t like people who don't help in handing over money to the driver in jeepney rides.</li>
                </ul>
            </div>
            """,
            unsafe_allow_html=True
...
elif st.session_state.selected_tab == "🎖️ Certifications & Seminars":
    st.subheader("Certifications & Seminars")
    st.markdown(
        """
        <div style='font-size: 1.2rem;'>
            <ul>
